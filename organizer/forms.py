...
#             'previous_experience_details': forms.Textarea(attrs={'rows': 3}),
#             'medical_details': forms.Textarea(attrs={'rows': 2}),
#         }
#
...
#
#         if is_player:
#             # ATHLETE MODE: Pre-filled info is locked, application info is required
...
#
#             # (Use the STEP-BY-STEP Div Layout we discussed earlier here)
#         else:
#             # ORGANIZER MODE: CRITICAL FIX
#             # Make athlete fields NOT required so the organizer can save the template
#             for field in athlete_fields:
#                 self.fields[field].required = False
#             for field in context_fields:
#                 self.fields[field].required = True
...
#                     Row(Column('event_name', css_class='col-md-7'), Column('sports', css_class='col-md-5')),
#                     Row(Column('level', css_class='col-md-4'), Column('address', css_class='col-md-8')),
#                 )
#             )
#
#
